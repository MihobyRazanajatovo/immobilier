                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Mon portefeuille</h4>
                            </div>
                        </div>
                        <div class="parking-lot">
                            <p>Montant actuel : <?php echo $portefeuille['montant']; ?> Ariary</p>

                            <h2>Demander une Recharge</h2>
                            <form action="<?php echo site_url('portefeuille/demander_recharge'); ?>" method="post">
