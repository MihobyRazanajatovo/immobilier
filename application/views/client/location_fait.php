...
<head>
    ...
    <title>Résultat du Loyer</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>

<body>
    <div class="container">
        <h1>Résultat du Loyer pour <?php echo $bien['nom']; ?></h1>
        <?php if (isset($client['email'])): ?>
            <p>Client : <?php echo $client['email']; ?></p>
        <?php else: ?>
            <p>Client inconnu</p>
        <?php endif; ?>
        <p>Date de début : <?php echo $debut; ?></p>
        <p>Date de fin : <?php echo $fin; ?></p>
        <p>Durée : <?php echo $mois; ?> mois</p>
        <p>Loyer total : <?php echo $loyer_total; ?> €</p>
