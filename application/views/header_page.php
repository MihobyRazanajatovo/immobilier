                    ...
                    <nav class="iq-sidebar-menu">
                        <ul id="iq-sidebar-toggle" class="side-menu">
                            <li class="sidebar-layout">
                                <a href="<?php echo base_url('accueil'); ?>" class="svg-icon">
                                    <i class="">
                            ...
                            <li class="sidebar-layout">
                                <a href="<?php echo base_url('profil'); ?>" class="svg-icon">
                                    <i class="">
                                    ...
                                    </i><span class="ml-2">Profil</span>
                                </a>
                            </li>
                            <li class="sidebar-layout">
                                <a href="<?php echo base_url('parking/show_voitures_stationnees'); ?>" class="svg-icon">
                                    <i class="">
                                        <svg class="svg-icon" id="iq-user-1-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </i><span class="ml-2">Enlever une voiture</span>
                                </a>
                            </li>
                            <li class="sidebar-layout">
                                <a href="<?php echo base_url('portefeuille/show_portefeuille'); ?>" class="svg-icon">
                                    <i class="">
                                        <svg class="svg-icon" id="iq-user-1-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </i><span class="ml-2">Mon portefeuille</span>
                                </a>
                            </li>
                        </ul>
                    </nav>
                                    ...
                                    <li class="nav-item nav-icon dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                            <li class="dropdown-item d-flex svg-icon">
                                                ...
                                                <a href="<?php echo base_url('Profil'); ?>">My Profile</a>
                                            </li>
