            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="<?php echo site_url('admin/total_rent_and_gain'); ?>" class="form-container">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" id="end_date" name="end_date" class="form-control" placeholder="Date">
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($results as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo number_format($row->gain, 2); ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
