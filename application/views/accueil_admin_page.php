...
<body>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                ...
                                <form action="<?php echo base_url('ResetDatabase/reset_tables'); ?>" method="post">
                                    <button type="submit" class="button-86">Réinitialiser</button>
                                </form>
                            </div>
                        </div>
                        <h1 id="clock"><?php echo isset($time) ? $time : date('H:i:s'); ?></h1>
                        <form action="<?php echo site_url('time/set_time'); ?>" method="post">
    ...
    <script>
        function startClock(initialTime) {
            let currentTime = new Date('1970-01-01T' + initialTime + 'Z');
            ...
            updateClock(); // Mettre à jour immédiatement pour éviter un délai d'une seconde
        }
    </script>
