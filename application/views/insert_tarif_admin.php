                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4>Insérer de nouveau tarif</h4>
                            </div>
                        </div>
                        <div class="card-body d-flex justify-content-between">
                            <form action="<?php echo base_url('tarif/add_tarif'); ?>" method="post">
                                <div class="form-group">
                                    <label for="tranche">tranche :</label>
                                    <input type="time" id="tranche" name="tranche" class="form-control" required><br>
                                </div>
                                <div class="form-group">
                                    <label for="prix">prix :</label>
                                    <input type="number" id="prix" name="prix" class="form-control" required><br>
                                </div>
                                <button type="submit" class="signup-btn">Ajouter Tarif</button>
                            </form>
                        </div>
                    </div>
                </div>
